...
## Designing and Building IoT Data Pipeline
...
### Building IoT Data Pipeline
#### Setting up MQTT Broker
#### Connecting to Network(Wokwi)
...
#### Connecting to MQTT Broker and Publishing the Data from Wokwi Simulation
...
#### Connecting to MQTT Broker and getting data to Node-Red
...
### Monitoring
#### Realtime Data Monitoring(Node-RED)
...
## Security, Scalability, Reliability and Performance
### Security
